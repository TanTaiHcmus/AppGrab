...
public class BikeDelivery extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_delivery);
        Intent intent = this.getIntent();
        double latiFrom = intent.getDoubleExtra("latiFrom", 0);
        double longiFrom = intent.getDoubleExtra("longiFrom", 0);
        double latiTo = intent.getDoubleExtra("latiTo", 0);
        double longiTo = intent.getDoubleExtra("longiTo", 0);
        ...
        textView = (TextView) findViewById(R.id.txt_tienBike);
    ...
    public void toCompleteDelivery(View view) {
        Intent intent = new Intent(BikeDelivery.this, ConfirmDelivery.class);
