...
public class OrderBike extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editNoiDi = (EditText) findViewById(R.id.edit_bike_from);
        editNoiDen = (EditText) findViewById(R.id.edit_bike_to);
        button = (Button) findViewById(R.id.btn_datxe_bike);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (noiDi != null && noiDen != null)
                {
                    ...
                    {
                        Intent intent = new Intent(OrderBike.this, BikeDelivery.class);
    ...
    private LatLng getLocationFromString(String location) {
        ...
        Geocoder geocoder = new Geocoder(OrderBike.this, Locale.getDefault());
